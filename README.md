...
## Estruturas de Dados
   ...
   - [Pilha](https://github.com/da-ferreira/algoritmos_e_estruturas_de_dados/blob/main/Estruturas%20de%20Dados/pilha.py)
...
## Ordenação
   ...
   - [Heap Sort](https://github.com/da-ferreira/algoritmos_e_estruturas_de_dados/blob/main/Ordenação/heapsort.py)
   - [Insertion Sort](https://github.com/da-ferreira/algoritmos_e_estruturas_de_dados/blob/main/Ordenação/insertionsort.py)
   - [Merge Sort](https://github.com/da-ferreira/algoritmos_e_estruturas_de_dados/blob/main/Ordenação/mergesort.py)
   - [Quick Sort](https://github.com/da-ferreira/algoritmos_e_estruturas_de_dados/blob/main/Ordenação/quicksort.py)
   - [Selection Sort](https://github.com/da-ferreira/algoritmos_e_estruturas_de_dados/blob/main/Ordenação/selectionsort.py)
